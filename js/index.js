...
fetch("https://arfp.eu/dataset/voyages.json").then(function(reponse) {
    return reponse.json();
}).then(function(data) {
    data.forEach(function(desti) {
        CreateVoyage(desti);
    });
});

/*Pour voir le comportement si le text est plus grand que la place que je lui donne */
